...
import 'package:fukatsongs/services/download/rust_download_service.dart';
import 'package:fukatsongs/src/rust/api/downloader/types.dart';
...
import 'package:fukatsongs/services/db/global_db.dart';
...
class DownloaderCubit extends Cubit<DownloaderState> {
  ...
  Future<void> _initializeDownloadService() async {
    ...
    await _downloadService.initialize(
      ...
      tempDir: path.join(tempDirectory.path, 'FukatMusic_downloads'),
    );
