...
ImageProvider<Object> getImageProviderSync(
  String? imageUrl, {
  String? fallbackUrl,
  String placeholderUrl = "assets/icons/fukat_logo.png",
}) {
...
class LoadImageCached extends StatefulWidget {
  ...
  const LoadImageCached({
    ...
    this.placeholderUrl = "assets/icons/fukat_logo.png",
...
class _LoadImageCachedState extends State<LoadImageCached> {
  ...
  int? get _memCacheWidth {
    if (widget.width == null) return 250; // reduced from 500
    final dpr = MediaQuery.of(context).devicePixelRatio;
    return (widget.width! * dpr).ceil().clamp(50, 500); // reduced max from 1500 to 500
  }
